\documentclass[a4paper,parskip=half,DIV=calc,12pt]{scrbook}
...
\begin{framed}
\begin{align*}
\F\ (p:\text{\texttt{if}})\ [v,c_0, c_1]\  ve\ b &=
\begin{cases}
...
\end{align*}
\begin{align*}
\aF\ (p:\text{\texttt{if}})\ [v,c_0, c_1]\  ve\ b &=
...
% Erklärung auf eine gerade Seite
